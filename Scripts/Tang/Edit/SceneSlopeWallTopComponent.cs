...
namespace Tang
{
    ...
    public class SlopeWallTopData
    {
        ...
        public Vector3[] GetVertices()
        {
            ...
            new Vector3(SceneComponentConstant.GapX * slopeX, SceneComponentConstant.GapY * slopeY, SceneComponentConstant.GapZ * widthZ),
            new Vector3(SceneComponentConstant.GapX * slopeX, SceneComponentConstant.GapY * slopeY, 0),
            };
        }
    }

    public class SceneSlopeWallTopComponent : SceneComponent
    {
        [SerializeField] public SlopeWallTopData wallData = new SlopeWallTopData();

        public override string ComponentType
        {
            get
            {
                return "SlopeWallTop_" + wallData.slopeX + "x" + wallData.slopeY + "x" + wallData.widthZ;
            }
        }
        ...
        public override object Data
        {
            ...
            set
            {
                wallData = (SlopeWallTopData)value;
            }
        }
