...
namespace Tang
{
    ...
    public class SideWallTopData
    {
        ...
        public Vector3[] GetVertices()
        {
            ...
            new Vector3(-SceneComponentConstant.GapX * widthX + SceneComponentConstant.GapZ * widthZ / 2f, 0, SceneComponentConstant.GapZ * widthZ),
            new Vector3(SceneComponentConstant.GapZ * widthZ / 2f, 0, SceneComponentConstant.GapZ * widthZ),
            };
        }
    }

    public class SceneSideWallTopComponent : SceneComponent
    {
        [SerializeField] public SideWallTopData wallData = new SideWallTopData();

        public override string ComponentType
        {
            get
            {
                return "SideWallTop_" + wallData.widthZ + "x" + wallData.widthX;
            }
        }
        ...
        public override object Data
        {
            ...
            set
            {
                wallData = (SideWallTopData)value;
            }
        }
