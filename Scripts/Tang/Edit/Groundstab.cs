...
namespace Tang
{
    ...
    public class GroundStab : SceneComponent
    {
        public GroundStabData data = new GroundStabData();
        ...
        public override void CreateMesh(string materialPath = "")
        {
            ...
            // Vector3 p2 = p1+new Vector3(width,0,0);

            // Vector3 p3 = p2 + new Vector3(0, height, 0);
            // Vector3 p4 = p1 + new Vector3(0, height, 0);
