...
{
    [System.Serializable]
    public class WallTriangleTopData
    {
        public int x = 0;
        public int y = 0;
        public int z = 0;

        [SerializeField] private float widthZ = 3;
        [SerializeField] private float widthY = 3;
        [SerializeField] private float widthX = 3;
    ...
    public class SceneWallTriangleTopComponent : SceneComponent
    {
        [SerializeField] public WallTriangleTopData wallData = new WallTriangleTopData();
        ...
        public override object Data
        {
            ...
            set
            {
                wallData = (WallTriangleTopData)value;
            }
        }
        ...
        public override void CreateMesh(string materialPath = "")
        {
            ...
            // 创建Renderer add by TangJian 2018/10/15 16:34
            {
                ...
                renderer1GameObject.layer = LayerMask.NameToLayer("WallTriangleTop");
